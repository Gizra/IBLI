FUNCTION ZNORMBIL_8BIT, fname, ns, nl, nb, periodicity, frstPeriod, frstPavgsd, lstPavgsd, noDataValue, minVal, maxVal, minVar, min5prct
COMPILE_OPT idl2
;!EXCEPT = 0
...
;
;  Restrictions:
;     - Input file must be an binary bil (NDVI scaled to 0, 255);
...
;  Usage:
;     rc = ZNORMBIL (fname, ns, nl, nb, periodicity, frstPeriod, frstPavgsd, lstPavgsd, noDataValue, minVal, maxVal, minVar, min5prct)
...
;     4. GIMMS (469 is the first band of 2001, 732 is the last of 2011)
;     print, ZNORMBIL_GIMMS ('G:\BACKUP\IMAGES\IBLI\GIMMS\Kenya_NDVI3g_filteredSG_cm1.stk', 112, 132, 732, 15, 13, 469, 732, -10000, 0, 10000, 500, 5)
;     5. SPOT (100 is the first band of 2001, 495 is the last of 2011)
;     print, ZNORMBIL_8BIT ('G:\BACKUP\IMAGES\IBLI\SPOT\SPOT_VGT_filtered_Kenya.img', 1008, 1232, 543, 10, 10, 100, 495, 0, 1, 255, 12, 25)
;                 ; note, last '25' corresponds to NDVI=0
;     6. eMODIS (1 is the first band of 2001, 396 is the last of 2011)
;     print, ZNORMBIL_8BIT ('F:\DATA\eMODIS_FEWSNET\processing\eMODIS_FEWS_Kenya.bil', 3400, 4300, 465, 10, 1, 1, 396, 0, 100, 200, 5, 102)
;     UPDATE (band 459 corresponds to 21-31 September 2013):
;     print, ZNORMBIL_8BIT ('F:\DATA\eMODIS_FEWSNET\processing\eMODIS_FEWS_Kenya.bil', 3400, 4300, 470, 10, 1, 1, 396, 0, 100, 200, 5, 102)
;     
;  Input parameters:
...
print , ' - - - Calculating Per Pixel Temporal : Average , STD , and diagnostics . . . - - - - ' 
;Loop on lines
...
; Write hdrs
fname=STRMID(fname_avg,0,STRLEN(fname_avg)-3)+'hdr'
OPENW, Wh, fname, /GET_LUN
PRINTF,Wh,'ENVI'
PRINTF,Wh,'description = {Historical average considering period '+ STRTRIM(frstPavgsd, 2)+' to '+STRTRIM(lstPavgsd,2)+'}'
...
fname=STRMID(fname_sd,0,STRLEN(fname_sd)-3)+'hdr'
OPENW, Wh, fname, /GET_LUN
PRINTF,Wh,'ENVI'
...
fname=STRMID(fname_dia,0,STRLEN(fname_dia)-3)+'hdr'
OPENW, Wh, fname, /GET_LUN
PRINTF,Wh,'ENVI'
...
fname=STRMID(fname_z,0,STRLEN(fname_z)-3)+'hdr'
OPENW, Wh, fname, /GET_LUN
PRINTF,Wh,'ENVI'
