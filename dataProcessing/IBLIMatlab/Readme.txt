...
jdw 6-2014; updted 7-2014

Run genRateMain to generate rates for LRLD and SRSD and combined annual contract.

At update, ensure the following:

1) Open genLRLDrate in matlab, and update last season year to reflect most recent avail data for rating
