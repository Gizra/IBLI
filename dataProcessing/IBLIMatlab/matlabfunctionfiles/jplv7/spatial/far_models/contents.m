% first-order spatial autoregressive model estimation functions
%
...
%           far_gd : An example of using far_g(), small dataset
%          far_gd2 : An example of using far_g(), large dataset
%          far_gd3 : An example of Metropolis-Hastings vs. sampling by inversion
%       far_timing : A timing comparison small vs large datasets
