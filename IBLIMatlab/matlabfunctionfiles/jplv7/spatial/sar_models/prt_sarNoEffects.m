...
%Don't print in this version...jdw
...
ubounds = bounds(1,1);
lbounds = bounds(1,2);
total_out(i,:) = [lbounds cmean  ubounds cmean./smean tdis_prb(cmean./smean,nobs)];
end;
...
ubounds = bounds(1,1);
lbounds = bounds(1,2);
indirect_out(i,:) = [lbounds cmean ubounds cmean./smean tdis_prb(cmean./smean,nobs)];
end;
...
ubounds = bounds(1,1);
lbounds = bounds(1,2);
direct_out(i,:) = [lbounds cmean ubounds cmean./smean tdis_prb(cmean./smean,nobs)];
end;
