...
csvwrite(strcat(filepathMain,'\OutRate\LRLD10rateFinal.csv'),rateFinalEth(:,1)); 
csvwrite(strcat(filepathMain,'\OutRate\LRLD15rateFinal.csv'),rateFinalEth(:,2)); 
csvwrite(strcat(filepathMain,'\OutRate\LRLD20rateFinal.csv'),rateFinalEth(:,3)); 
csvwrite(strcat(filepathMain,'\OutRate\LRLD25rateFinal.csv'),rateFinalEth(:,4)); 
csvwrite(strcat(filepathMain,'\OutRate\LRLD30rateFinal.csv'),rateFinalEth(:,5)); 
...
csvwrite(strcat(filepathMain,'\OutCurrentIndex\LRLD10indem.csv'),indemfinal(:,1));
csvwrite(strcat(filepathMain,'\OutCurrentIndex\LRLD15indem.csv'),indemfinal(:,2));
csvwrite(strcat(filepathMain,'\OutCurrentIndex\LRLD20indem.csv'),indemfinal(:,3));
csvwrite(strcat(filepathMain,'\OutCurrentIndex\LRLD25indem.csv'),indemfinal(:,4));
csvwrite(strcat(filepathMain,'\OutCurrentIndex\LRLD30indem.csv'),indemfinal(:,5));
