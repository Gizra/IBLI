...
case {'sem_gc'} % <=================== Gibbs spatial error model
...
case {'semt_g','semt_gc'} % <=================== Gibbs spatial error tobit model
...
case {'semp_g','semp_gc'} % <=================== Gibbs spatial error Probit model
...
fprintf(fid,'\n');
if results.novi == 1
fprintf(fid,'Bayesian homoscedastic spatial error Probit model \n');
else
fprintf(fid,'Bayesian heteroscedastic spatial error Probit model \n');
end;
if (nflag == 1)
fprintf(fid,'Dependent Variable = %16s \n',vnames(1,:));
end;
...
case {'sar_g','sar_gc'} % <=================== Gibbs spatial autoregressive model
