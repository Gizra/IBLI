function prt_bmae(results,vnames,fid)
% PURPOSE: print results from sar_gcbma, sem_gcbma functions
% -------------------------------------------------
% usage: prt_bmae(results,vnames)
% where results is a structure returned by sem_gbma
...
fprintf(fid,'SEM BMA Model information \n');
...
otherwise
error('prt_bmae: problem with switch statement');
