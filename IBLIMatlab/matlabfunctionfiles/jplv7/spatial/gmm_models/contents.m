...
%         sac_gmmd : An example of using sac_gmm on a small data set
...
%         sar_gmmd : An example of using sar_gmm on a small data set
...
%          sem_gmm : computes Generalized Moments Estimates for Spatial Error Model
...
%        sem_gmmd4 : Another Monte Carlo example of using sem_gmm
%       sem_monte1 : Monte Carlo Demonstration file for sem_gmm
%       sem_monte2 : Monte Carlo Demonstration file for sem2_gmm
% utility functions:
