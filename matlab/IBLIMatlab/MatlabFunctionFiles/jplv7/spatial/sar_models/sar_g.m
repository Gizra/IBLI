...
% written by:
% James P. LeSage, last updated 5/2009
...
function [nu,d0,rval,mm,kk,rho,sige,rmin,rmax,detval,ldetflag,sflag,eflag,order,iter,novi_flag,c,T,inform_flag,a1,a2,logmflag,p,cflag] = sar_parse(prior,k)
