...
%% B.DILLON ADDITION HERE
if isfield(results,'outsamp')
    fprintf(fid,'Out of Sample Observations =%6d \n',length(results.outsamp));
end
fprintf(fid,'***************************************************************\n');
...
%% B.Dillon added some stuff here so it would print out the VIF values if they are populated in the structure
%%
