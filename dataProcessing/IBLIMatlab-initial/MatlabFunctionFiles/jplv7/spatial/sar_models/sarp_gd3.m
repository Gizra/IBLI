% PURPOSE: An example of using sarp_g()
%          Gibbs sampling spatial autoregressive model
%          on a large data set                    
%---------------------------------------------------
% USAGE: sarp_gd3 (see sarp_gd for a small data set)
%---------------------------------------------------
...
result2 = sarp_g(y,xmat,W,ndraw,nomit,prior);
prt(result2,vnames);

tt=1:n;
plot(tt,y,'og',tt,result2.yprob,'.r',tt,result0.yhat,'.b');
legend('0,1 y-values','sar probs','probit probs');
